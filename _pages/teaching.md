...
<div style="margin-top: 40px;padding: 30px;background: #F7C39F;border-radius: 18px">
    ...
    <div style="background: #ED7D31; padding: 18px; border-radius: 18px; text-align: center; font-weight: 700;font-size: 1.05rem"> Environmental Geology</div>
    ...
    <div style="background: #ED7D31; padding: 18px; border-radius: 18px; text-align: center; font-weight: 700;font-size: 1.05rem;">Environmental Field Method</div>
    </div>
</div>
